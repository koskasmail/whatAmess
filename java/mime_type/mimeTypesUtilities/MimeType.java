...
public class MimeType {
	...
	public MimeType() {	
		System.out.println(getContentTypeByFileName("/home/yaron/test/122_PPS_.pps.txt"));
	}
	
    public static String getContentTypeByFileName(String fileName) {
        // search with file extention
        ...
        System.out.println("b2. contentType >>> " + contentType);
        if (!StringUtils.hasText(contentType)) {
            String extension = FilenameUtils.getExtension(fileName);
            contentType = fileExtensionMap.get(extension);
            System.out.println("2. contentType >>> " + contentType);
        }
        return contentType;
    }
