...
//	@RequestMapping(method=RequestMethod.GET,value="/whoami/{me}")
	...
	@RequestMapping(method=RequestMethod.POST,value="/gog")
	public String gog(@RequestHeader String id) 
	{
		String myData = id ;
		String output = "";
	...
	@RequestMapping(method=RequestMethod.POST,value="/jronLog")
	public String gog(@RequestHeader String subject, String content) 
	{
		String stSubject = subject ;
		String stContent = content;
		String output = "";
		
		output += "<div>"+ stSubject  + "" + content +"</div>";
		output += "<div>"+ stContent +"</div>";
	 ...
	 public String addTopic(@RequestBody String user, String password)
	 {
