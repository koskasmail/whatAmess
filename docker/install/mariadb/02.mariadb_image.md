...
wodby/mariadb       Installing Docker on Your System with the Universal Installation Script
...
curl -sSL https://get.docker.com/ | sh
                         Alpine-based MariaDB container image with or…   8  
```
...
Usage:  docker ps [OInstalling Docker on Your System with the Universal Installation Script
