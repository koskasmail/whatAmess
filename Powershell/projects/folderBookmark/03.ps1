...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <!-- Search / Filter Field (Moved below the table) -->
        <Grid Grid.Row="3">
            <Grid.ColumnDefinitions>
...
function Refresh-FilteredRecords {
    ...
    # Filter master list across Name, Description, and Path
...
# Event: Live Search / Filter as text changes
$txtFilter.Add_TextChanged({
    Refresh-FilteredRecords
})

# Event: Clear Search Filter Button
